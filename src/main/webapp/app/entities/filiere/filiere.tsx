  ...
  return (
    <div>
      <h2 id="filiere-heading" data-cy="FiliereHeading">
        <Translate contentKey="gestionUniversitaireApp.filiere.home.title">Filieres</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gestionUniversitaireApp.filiere.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/filiere/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gestionUniversitaireApp.filiere.home.createLabel">Create new Filiere</Translate>
          </Link>
        </div>
      </h2>
        ...
        {filiereList && filiereList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gestionUniversitaireApp.filiere.id">ID</Translate>{' '}
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (location.href = `/filiere/${filiere.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gestionUniversitaireApp.filiere.home.notFound">No Filieres found</Translate>
            </div>
          )
        )}
      </div>
