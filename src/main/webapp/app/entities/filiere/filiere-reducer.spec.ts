...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './filiere.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILIERE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILIERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILIERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILIERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILIERE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILIERE actions', async () => {
      const expectedActions = [
        {
