...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALLEEXAMEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALLEEXAMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALLEEXAMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALLEEXAMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALLEEXAMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALLEEXAMEN actions', async () => {
      const expectedActions = [
        {
