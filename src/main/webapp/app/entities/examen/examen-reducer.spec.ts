...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './examen.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXAMEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXAMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXAMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXAMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXAMEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXAMEN actions', async () => {
      const expectedActions = [
        {
