...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './niveau.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<INiveau> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NIVEAU_LIST actions', async () => {
    ...
    it('dispatches FETCH_NIVEAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NIVEAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NIVEAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NIVEAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NIVEAU actions', async () => {
      const expectedActions = [
        {
